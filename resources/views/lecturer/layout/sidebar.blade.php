...
<div class="aside-menu flex-column-fluid ps-5 pe-3 mb-9" id="kt_aside_menu">
    ...
    <div class="w-100 hover-scroll-overlay-y d-flex pe-2" id="kt_aside_menu_wrapper"
        ...
        <div class="menu menu-column menu-rounded fw-bold my-auto" id="#kt_aside_menu"
            data-kt-menu="true">
            <div class="menu-item">
                <a class="menu-link active" href="{{route('lecturer.dashboard')}}">
            ...
            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                ...
                <div class="menu-sub menu-sub-accordion">
                    ...
                    <div class="menu-item">
                        <a class="menu-link" href="{{route('lecturer.courses.all')}}">
            ...
            <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                <span class="menu-link">
                    ...
                    <span class="badge badge-success"> {{count(auth()->user()->lecturer->unread_notifications)}}</span>
                    <span class="menu-arrow"></span>
                </span>
                <div class="menu-sub menu-sub-accordion">
                                        
                    <div class="menu-item">
                        <a class="menu-link" href="{{route('lecturer.notifications.all')}}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
    ...
    <div class="d-flex flex-stack">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="symbol symbol-circle symbol-40px">
                <img src="{{asset('storage/lecturers/images/'.auth()->user()->image)}}" alt="photo" />
            </div>
            <!--end::Avatar-->
            <!--begin::User info-->
            <div class="ms-2">
                <!--begin::Name-->
                <a href="#" class="text-gray-800 text-hover-primary fs-6 fw-bolder lh-1">{{auth()->user()->fullname}}</a>
                <!--end::Name-->
                <!--begin::Major-->
                <span class="text-muted fw-bold d-block fs-7 lh-1">Lecturer</span>
                <!--end::Major-->
            </div>
            <!--end::User info-->
        </div>
